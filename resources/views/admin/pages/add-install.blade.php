...
<div class="content-i">
  ...
  <form id="formValidate" method="POST" action="./add-install" novalidate="true">
    <?php
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <label for=""> Phone Number </label><input class="form-control" data-error="Please enter a valid country India phone number." pattern="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$" placeholder="Enter phone number" required="required" type="text" name="installer_phone">
          <div class="help-block form-text with-errors form-control-feedback"></div>
        </div>
        <div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <label for=""> Number of Projects installed </label><input class="form-control" required="required" placeholder="Enter Number of Projects installed" type="text" pattern="[0-9]+([.][0-9]+)?" data-error="The number input must start with a number and use a dot as a decimal character." name="installer_number_of_project">
          <div class="help-block form-text with-errors form-control-feedback"></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for=""> Maximum Install Experience in kW </label><input class="form-control" required="required" placeholder="Enter Maximum Install Experience in kW" type="text" pattern="[0-9]+([.][0-9]+)?" data-error="The number input must start with a number and use a dot as a decimal character." name="installer_maximum_installer">
          <div class="help-block form-text with-errors form-control-feedback"></div>
        </div>
